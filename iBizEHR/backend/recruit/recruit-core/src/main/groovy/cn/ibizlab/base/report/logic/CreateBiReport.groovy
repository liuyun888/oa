package cn.ibizlab.base.report.logic
...
/**
 * 实体[REPORT]处理逻辑[建立报表扩展模型]运行时对象
 * 此代码用户功能扩展代码
 *
 * 建立报表扩展模型
 */
class CreateBiReport extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CreateBiReport.class)
    ...
    /**
     * 执行逻辑节点[从模板初始化模型]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[构造智能报表默认参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[建立bi报表扩展模型]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
