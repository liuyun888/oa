...
/**
 * 实体[HR_CANDIDATE]处理逻辑[获取工作台我的事项数]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class GetMySummaryCount extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetMySummaryCount.class)
    ...
    /**
     * 执行逻辑节点[考试/测评返回数]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
