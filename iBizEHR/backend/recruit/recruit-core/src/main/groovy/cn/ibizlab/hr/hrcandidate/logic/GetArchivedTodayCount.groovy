...
/**
 * 实体[HR_CANDIDATE]处理逻辑[今日归档人数]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class GetArchivedTodayCount extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetArchivedTodayCount.class)
