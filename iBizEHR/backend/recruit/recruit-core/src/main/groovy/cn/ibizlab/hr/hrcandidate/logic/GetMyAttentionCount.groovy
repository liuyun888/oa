...
/**
 * 实体[HR_CANDIDATE]处理逻辑[获取工作台我的关注数]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class GetMyAttentionCount extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetMyAttentionCount.class)
