package cn.ibizlab.hr.hridea.logic
...
/**
 * 实体[HR_IDEA]处理逻辑[招聘需求搜索栏计数]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class IdeaStatusCount extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(IdeaStatusCount.class)
