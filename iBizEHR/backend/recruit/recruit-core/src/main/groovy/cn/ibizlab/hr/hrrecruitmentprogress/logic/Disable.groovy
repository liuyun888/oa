package cn.ibizlab.hr.hrrecruitmentprogress.logic
...
/**
 * 实体[HR_RECRUITMENT_PROGRESS]处理逻辑[停用]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class Disable extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(Disable.class)
    ...
    /**
     * 执行逻辑节点[设置状态为停用]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
