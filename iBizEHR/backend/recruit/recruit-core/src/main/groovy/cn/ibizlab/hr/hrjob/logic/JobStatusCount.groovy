package cn.ibizlab.hr.hrjob.logic
...
/**
 * 实体[HR_JOB]处理逻辑[职位状态计数器]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class JobStatusCount extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(JobStatusCount.class)
