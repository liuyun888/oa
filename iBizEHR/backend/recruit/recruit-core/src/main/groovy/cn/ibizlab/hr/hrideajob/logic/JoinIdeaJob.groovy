package cn.ibizlab.hr.hrideajob.logic
...
/**
 * 实体[HR_IDEA_JOB]处理逻辑[关联职位]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class JoinIdeaJob extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(JoinIdeaJob.class)
    ...
    protected void onExecutePSDELogicNode(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        switch (iPSDELogicNode.getCodeName()) {
            ...
            case "RAWSFCODE":
                //执行逻辑节点[需求关联职位]
                executeRAWSFCODE(iDELogicSession, iPSDELogicNode)
                break
            case "END1":
                //执行逻辑节点[结束]
    ...
    /**
     * 执行逻辑节点[需求关联职位]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    private void executeRAWSFCODE(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        // 执行Groovy脚本代码
