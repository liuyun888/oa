package cn.ibizlab.extension.pssysbireport.logic
...
/**
 * 实体[PSSYSBIREPORT]处理逻辑[更新报表]运行时对象
 * 此代码用户功能扩展代码
 *
 * 更新报表
 */
class UpdateReport extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(UpdateReport.class)
