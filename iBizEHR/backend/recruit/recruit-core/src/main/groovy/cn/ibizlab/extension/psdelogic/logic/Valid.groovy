...
/**
 * 实体[PSDELOGIC]处理逻辑[切换启用状态]运行时对象
 * 此代码用户功能扩展代码
 *
 * 切换启用状态
 */
class Valid extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(Valid.class)
