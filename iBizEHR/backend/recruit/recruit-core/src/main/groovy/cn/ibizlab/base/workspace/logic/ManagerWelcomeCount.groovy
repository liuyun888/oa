package cn.ibizlab.base.workspace.logic
...
/**
 * 实体[WORKSPACE]处理逻辑[用人经理欢迎页计数器]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class ManagerWelcomeCount extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ManagerWelcomeCount.class)
