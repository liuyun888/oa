package cn.ibizlab.hr.hrofferapproval.logic
...
/**
 * 实体[HR_OFFER_APPROVAL]处理逻辑[用人经理-我的offer-搜索栏计数器]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class MyOfferCount extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MyOfferCount.class)
