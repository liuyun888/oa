...
/**
 * 实体[HR_CANDIDATE]处理逻辑[获取工作台面试数]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class GetMyInterviewCount extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetMyInterviewCount.class)
