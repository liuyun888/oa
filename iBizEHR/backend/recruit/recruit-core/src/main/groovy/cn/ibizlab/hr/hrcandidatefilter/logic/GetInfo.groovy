...
/**
 * 实体[HR_CANDIDATE_FILTER]处理逻辑[获取信息]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class GetInfo extends DELogicRuntime {
    ...
    /**
     * 执行逻辑节点[设置过滤器参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
