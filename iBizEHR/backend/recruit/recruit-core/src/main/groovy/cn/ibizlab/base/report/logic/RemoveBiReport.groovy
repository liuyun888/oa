...
/**
 * 实体[REPORT]处理逻辑[移除报表扩展模型]运行时对象
 * 此代码用户功能扩展代码
 *
 * 移除报表扩展模型
 */
class RemoveBiReport extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RemoveBiReport.class)
