...
/**
 * 实体[HR_APPLICANT]处理逻辑[附加候选人操作权限（临时）]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class AddCandidateOppriv extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AddCandidateOppriv.class)
