...
/**
 * 实体[HR_OFFER]处理逻辑[填充offer主键]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class FillId extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(FillId.class)
    ...
    /**
     * 执行逻辑节点[设置ID为申请ID]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置申请offer标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
