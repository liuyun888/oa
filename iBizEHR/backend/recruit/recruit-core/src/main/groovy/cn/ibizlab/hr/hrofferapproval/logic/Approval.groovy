...
/**
 * 实体[HR_OFFER_APPROVAL]处理逻辑[审批]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class Approval extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(Approval.class)
    ...
    /**
     * 执行逻辑节点[设置审核状态]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[更新offer审批]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
