package cn.ibizlab.hr.hrcandidatefilterdetail.logic
...
/**
 * 实体[HR_CANDIDATE_FILTER_DETAIL]处理逻辑[用人经理-简历筛选-搜索栏计数器]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class MyFilterCount extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MyFilterCount.class)
    ...
    /**
     * 执行逻辑节点[待筛选的候选人]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[可面试的候选人]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[已推荐的候选人]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
