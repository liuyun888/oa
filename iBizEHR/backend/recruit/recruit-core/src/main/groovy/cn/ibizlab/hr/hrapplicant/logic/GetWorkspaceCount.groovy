...
/**
 * 实体[HR_APPLICANT]处理逻辑[获取工作台数据]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class GetWorkspaceCount extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetWorkspaceCount.class)
    ...
    /**
     * 执行逻辑节点[待发送offer人数]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
