package cn.ibizlab.hr.hroffer.logic
...
/**
 * 实体[HR_OFFER]处理逻辑[更新申请关联offer]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class UpdateRelOffer extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(UpdateRelOffer.class)
    ...
    /**
     * 执行逻辑节点[设置offer标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
