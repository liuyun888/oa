...
/**
 * 实体[HR_RECRUITMENT_PROGRESS]处理逻辑[启用]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class Enable extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(Enable.class)
    ...
    /**
     * 执行逻辑节点[设置状态为启用]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
