...
/**
 * 实体[HR_APPLICANT]处理逻辑[设置星标]运行时对象
 * 此代码用户功能扩展代码
 *
 * 设置为星标项目
 */
class Favorite extends DELogicRuntime {
    ...
    /**
     * 执行逻辑节点[填充用户标识和收藏业务对象标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
