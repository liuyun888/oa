package cn.ibizlab.hr.hrinterviewfeedback.logic
...
/**
 * 实体[HR_INTERVIEW_FEEDBACK]处理逻辑[用人经理-我的面试-搜索栏计数器]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class MyInterviewCount extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MyInterviewCount.class)
