...
/**
 * 实体[REPORT]处理逻辑[同步模板模型]运行时对象
 * 此代码用户功能扩展代码
 *
 * 同步模板模型
 */
class SyncModel extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SyncModel.class)
    ...
    /**
     * 执行逻辑节点[准备report标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取bireport]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
