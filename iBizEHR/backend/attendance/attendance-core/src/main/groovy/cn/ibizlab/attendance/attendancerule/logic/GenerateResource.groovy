...
/**
 * 实体[ATTENDANCE_RULE]处理逻辑[生成Odoo资源关联]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class GenerateResource extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GenerateResource.class)
    ...
    /**
     * 执行逻辑节点[更新人员关联工作时间]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[更新资源关联工作时间]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
