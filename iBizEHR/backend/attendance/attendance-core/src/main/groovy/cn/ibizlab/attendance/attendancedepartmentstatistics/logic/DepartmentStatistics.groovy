package cn.ibizlab.attendance.attendancedepartmentstatistics.logic
...
/**
 * 实体[ATTENDANCE_DEPARTMENT_STATISTICS]处理逻辑[部门统计]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class DepartmentStatistics extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DepartmentStatistics.class)
