package cn.ibizlab.attendance.attendancecheckinapplication.logic
...
/**
 * 实体[ATTENDANCE_CHECKIN_APPLICATION]处理逻辑[申请作废]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class Cancellation extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(Cancellation.class)
