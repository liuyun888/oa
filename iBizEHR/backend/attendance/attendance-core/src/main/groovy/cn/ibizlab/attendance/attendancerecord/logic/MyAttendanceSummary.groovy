...
/**
 * 实体[ATTENDANCE_RECORD]处理逻辑[月底汇总_我的出勤统计]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class MyAttendanceSummary extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MyAttendanceSummary.class)
