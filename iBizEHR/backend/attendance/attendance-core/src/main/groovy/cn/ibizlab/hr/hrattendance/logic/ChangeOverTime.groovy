...
/**
 * 实体[HR_ATTENDANCE]处理逻辑[更新/创建加班记录]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class ChangeOverTime extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ChangeOverTime.class)
    ...
    /**
     * 执行逻辑节点[累加当天其他加班时长]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
