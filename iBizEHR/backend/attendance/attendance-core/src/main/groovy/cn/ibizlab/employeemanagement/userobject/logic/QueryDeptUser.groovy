package cn.ibizlab.employeemanagement.userobject.logic
...
/**
 * 实体[USER_OBJECT]处理逻辑[查询部门/人员]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class QueryDeptUser extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(QueryDeptUser.class)
