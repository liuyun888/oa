...
/**
 * 实体[ATTENDANCE_SCHEDULE]处理逻辑[排班视图查询]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class AttendanceSchedules extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AttendanceSchedules.class)
