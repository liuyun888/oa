...
/**
 * 实体[ATTENDANCE_RULE]处理逻辑[同步删除Odoo相关]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class RemoveOdooData extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RemoveOdooData.class)
