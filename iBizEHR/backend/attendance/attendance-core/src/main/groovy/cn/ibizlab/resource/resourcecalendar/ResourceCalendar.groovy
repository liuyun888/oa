...
class ResourceCalendar extends GroovyDataEntityRuntime<ResourceCalendar,ResourceCalendarDTO,ResourceCalendarFilterDTO> {
    ...
    public static final String ACTION_FILLDRAFT = "fillDraft"
     ...
     * @throws Throwable
     */
    @DEAction(ACTION_FILLDRAFT)
    def fillDraft(ResourceCalendarDTO dto) throws Throwable {
        this.execute(ACTION_FILLDRAFT, dto, ResourceCalendarDTO.class)
    }
