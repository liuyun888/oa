...
/**
 * 实体[ATTENDANCE_RECORD]处理逻辑[异常记录(特定搜索条件)]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class AbnormalRecord extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AbnormalRecord.class)
