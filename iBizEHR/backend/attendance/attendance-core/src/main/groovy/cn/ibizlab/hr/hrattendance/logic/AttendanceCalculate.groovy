...
/**
 * 实体[HR_ATTENDANCE]处理逻辑[考勤统计计算]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class AttendanceCalculate extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AttendanceCalculate.class)
