...
/**
 * 实体[ATTENDANCE_RULE]处理逻辑[生成Odoo工作时间]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class GenerateOther extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GenerateOther.class)
