export default {
  appDEFields: [
    ...
    },
    {
      codeName: 'name',
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.SCOPE.NAME',
      },
      logicName: '范围名称',
      predefinedType: 'NONE',
      stdDataType: 25,
    ...
    },
    {
      codeName: 'create_uid',
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.SCOPE.CREATE_UID',
      },
      logicName: '创建人',
      predefinedType: 'NONE',
      stdDataType: 25,
    ...
    },
    {
      codeName: 'write_date',
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.SCOPE.WRITE_DATE',
      },
      logicName: '更新时间',
      predefinedType: 'NONE',
      stdDataType: 5,
    ...
    },
    {
      ...
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.SCOPE.CREATE_DATE',
      },
      logicName: '创建时间',
      predefinedType: 'NONE',
      stdDataType: 5,
    ...
    },
    {
      codeName: 'write_uid',
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.SCOPE.WRITE_UID',
      },
      logicName: '更新人',
      predefinedType: 'NONE',
      stdDataType: 25,
    ...
    },
    {
      ...
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.SCOPE.END_BASE_TIME',
      },
      logicName: '结束基准时间（分钟）',
      predefinedType: 'NONE',
      stdDataType: 5,
    ...
    },
    {
      ...
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.SCOPE.START_BASE_TIME',
      },
      logicName: '开始基准时间（分钟）',
      predefinedType: 'NONE',
      stdDataType: 5,
    ...
    },
    {
      codeName: 'shift_name',
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.SCOPE.SHIFT_NAME',
      },
      logicName: '班次名称',
      predefinedType: 'NONE',
      stdDataType: 25,
    ...
    },
    {
      codeName: 'shift_id',
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.SCOPE.SHIFT_ID',
      },
      logicName: '班次ID',
      predefinedType: 'NONE',
      stdDataType: 25,
  ...
  appDEMethodDTOs: [
    {
      codeName: 'attendance_scope_dto',
      appDEMethodDTOFields: [
        {
          codeName: 'early_for_absenteeism',
          logicName: '缺勤判定阈值',
          appDEFieldId: 'early_for_absenteeism',
          sourceType: 'DEFIELD',
          stdDataType: 9,
          type: 'SIMPLE',
          allowEmpty: true,
        ...
        },
        {
          codeName: 'late_for_absenteeism',
          logicName: '缺勤判定阈值',
          appDEFieldId: 'late_for_absenteeism',
          sourceType: 'DEFIELD',
          stdDataType: 9,
          type: 'SIMPLE',
          allowEmpty: true,
    ...
    {
      codeName: 'attendance_scope_filter_dto',
      appDEMethodDTOFields: [
        {
          codeName: 'n_id_eq',
          logicName: '主键',
        ...
        },
        {
          ...
          type: 'SIMPLE',
          allowEmpty: true,
          id: 'n_shift_name_like',
        },
      ],
      sourceType: 'DE',
      type: 'DEFILTER',
      id: 'attendance_scope_filter_dto',
    },
  ],
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'attendance_scope_dto',
        type: 'DTO',
        name: 'CheckKeyInput',
        id: 'checkkeyinput',
      },
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'attendance_scope_filter_dto',
        type: 'DTO',
        name: 'DefaultInput',
        id: 'defaultinput',
      },
  ...
  codeName: 'attendance_scope',
  deapicodeName: 'attendance_scope',
  deapicodeName2: 'attendance_scopes',
  deapitag: 'ATTENDANCE_SCOPE',
  dataAccCtrlArch: 1,
  dataAccCtrlMode: 1,
  enableUIActions: 15,
  keyAppDEFieldId: 'id',
  lnlanguageRes: {
    lanResTag: 'DE.LNAME.ATTENDANCE_SCOPE',
  },
  logicName: '时间范围',
  ...
  minorAppDERSs: [
    {
      ...
      majorAppDataEntityId: 'attendanceapp.attendance_shift',
      nestedAppDEDataSetId: 'fetchdefault',
      parentAppDEFieldId: 'shift_id',
      parentTextAppDEFieldId: 'shift_name',
      rsmode: 1,
      rstype: 'DER1N',
      removeActionType: 1,
      tempDataOrder: 10,
      name: 'DER1N_ATTENDANCE_SCOPE_ATTENDANCE_SHIFT_SHIFT_ID',
      id: 'attendance_shift',
    },
    {
      actionRSMode: 1,
  ...
  id: 'attendanceapp.attendance_scope',
  codeName2: 'attendance_scopes',
  requestPaths: [
    'attendance_rules/${attendance_rule}/attendance_shifts/${attendance_shift}/attendance_scopes/${attendance_scope}',
    'attendance_shifts/${attendance_shift}/attendance_scopes/${attendance_scope}',
  ],
};
