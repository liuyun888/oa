export default {
  ...
  appDEMethodDTOs: [
    {
      codeName: 'attendance_gps_location_dto',
    ...
    {
      codeName: 'attendance_gps_location_filter_dto',
      appDEMethodDTOFields: [
        {
          codeName: 'n_id_eq',
          logicName: '主键',
      ...
      sourceType: 'DE',
      type: 'DEFILTER',
      id: 'attendance_gps_location_filter_dto',
    },
  ],
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'attendance_gps_location_dto',
        type: 'DTO',
        output: true,
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'attendance_gps_location_filter_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
  ...
  codeName: 'attendance_gps_location',
  deapicodeName: 'attendance_gps_location',
  deapicodeName2: 'attendance_gps_locations',
  deapitag: 'ATTENDANCE_GPS_LOCATION',
  dataAccCtrlArch: 1,
  dataAccCtrlMode: 1,
  enableUIActions: 15,
  keyAppDEFieldId: 'id',
  ...
  id: 'attendanceapp.attendance_gps_location',
  codeName2: 'attendance_gps_locations',
  requestPaths: [
    'attendance_rules/${attendance_rule}/attendance_gps_locations/${attendance_gps_location}',
  ],
};
