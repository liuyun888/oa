export default {
  ...
  deviewId: '0d3008eb0e5e1b40b268f38fc7fea4a3',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.HR_ATTENDANCE',
  },
  caption: '出勤',
  codeName: 'hr_attendance_multi_data_view',
    ...
    controls: [
      {
        ...
        controlParam: {
          ctrlParams: {
            DEFAULTGROUP: 'employee_name,check_in',
          },
          id: 'searchbar',
        },
        ...
        controls: [
          {
            ...
            codeName: 'multi_data_view_grid_batchtoolbar',
            controlType: 'TOOLBAR',
            logicName: '批操作工作栏（出勤）',
            appDataEntityId: 'attendanceapp.hr_attendance',
            controlParam: {
            ...
            id: 'multi_data_view_grid_batchtoolbar',
          },
        ],
        codeName: 'main',
      ...
      },
      {
        ...
        controlType: 'TOOLBAR',
        logicName: '出勤实体管理视图_工具栏',
        appDataEntityId: 'attendanceapp.hr_attendance',
        controlParam: {
          id: 'toolbar',
        },
        modelId: '3c39e5bd128b320295cb8b387e3ccb08',
        modelType: 'PSDETOOLBAR',
        name: 'toolbar',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'a67a99599d07efdf4b36e0e5f0441933',
  modelType: 'PSAPPDEVIEW',
  name: 'hr_attendancemulti_data_view',
  id: 'attendanceapp.hr_attendance_multi_data_view',
};
