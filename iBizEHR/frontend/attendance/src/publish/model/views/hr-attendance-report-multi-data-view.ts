export default {
  mdctrlActiveMode: 1,
  loadDefault: true,
  deviewCodeName: 'report_multi_data_view',
  deviewId: 'f3994fcfb9c5044fe4fce26487ae16c9',
  accUserMode: 2,
  capLanguageRes: {
    ...
    controls: [
      {
        ...
        modelId: '152b5ea47c39ae32ddbf47eb22d0ada0',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'attendanceapp.hr_attendance.search_bar',
      },
      {
      ...
      },
      {
        ...
        controls: [
          {
            ...
            codeName: 'report_multi_data_view_pivottable_batchtoolbar',
            controlType: 'TOOLBAR',
            logicName: '批操作工作栏（出勤）',
            appDataEntityId: 'attendanceapp.hr_attendance',
            controlParam: {
              id: 'pivottable_batchtoolbar',
            },
            modelId: '8a524bad3e4ade41aa23d88260d6de73',
            modelType: 'PSDETOOLBAR',
            name: 'pivottable_batchtoolbar',
            id: 'report_multi_data_view_pivottable_batchtoolbar',
          },
        ],
        ...
        modelId: '9aade14129acf05b6d0866d702f13ac1',
        modelType: 'PSDEGRID',
        name: 'pivottable',
        id: 'attendanceapp.hr_attendance.pivot_table',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.HR_ATTENDANCE',
        ...
        caption: '报表',
        codeName: 'report_multi_data_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'attendanceapp.hr_attendance',
        controlParam: {},
        name: 'captionbar',
        id: 'report_multi_data_view_captionbar',
      },
    ],
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '584195c8b0c37943177c6f355ca2f95a',
  modelType: 'PSAPPDEVIEW',
  name: 'hr_attendancereport_multi_data_view',
