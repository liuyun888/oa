export default {
  ...
  loadDefault: true,
  deviewCodeName: 'hm_edit_view',
  deviewId: 'e9027d4a06bfce000dd8c71b0723779f',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.HR_OFFER_APPROVAL',
  },
  caption: 'Offer审核详情',
  codeName: 'hr_offer_approval_hm_edit_view',
  ...
  controls: [
    {
      xdataControlName: 'form',
      codeName: 'hm_edit_view_toolbar',
      controlType: 'TOOLBAR',
      logicName: 'Offer审核详情（用人经理）_工具栏',
      appDataEntityId: 'web.hr_offer_approval',
      controlParam: {
        id: 'toolbar',
      },
      modelId: 'fb57a313dfbbc95ca9e390abfee5dee0',
      modelType: 'PSDETOOLBAR',
      name: 'toolbar',
      id: 'hm_edit_view_toolbar',
    },
    {
      createControlAction: {
                          ...
                          deformDetails: [
                            {
                              ...
                              parentDataJO: {
                                srfparentdename: 'HR_OFFER_APPROVAL',
            ...
            },
            {
              ...
              deformDetails: [
                ...
                },
                {
                  actionType: 'UIACTION',
                  buttonStyle: 'DEFAULT',
                  uiactionId: 'approval@hr_offer_approval',
                  tooltip: '审核',
      ...
      codeName: 'hm_edit_view_form',
      controlType: 'FORM',
      logicName: 'Offer审核详情（用人经理）_表单',
      appDataEntityId: 'web.hr_offer_approval',
      controlParam: {
        id: 'form',
      },
      modelId: 'b1bb39c4ee95bb89b3c9b128ab331ab1',
      modelType: 'PSDEFORM_EDITFORM',
      name: 'form',
      id: 'web.hr_offer_approval.hm_edit_view_form',
    },
    {
      codeName: 'hm_edit_view_datainfobar',
    ...
    },
    {
      ...
      caption: 'Offer审核详情',
      codeName: 'hm_edit_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'web.hr_offer_approval',
      controlParam: {},
      name: 'captionbar',
      id: 'hm_edit_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '6bf1cf51bb090f5e19384de8a252dfb4',
  modelType: 'PSAPPDEVIEW',
  name: 'hr_offer_approvalhm_edit_view',
  id: 'web.hr_offer_approval_hm_edit_view',
};
