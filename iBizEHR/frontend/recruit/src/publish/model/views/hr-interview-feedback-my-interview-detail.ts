export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'my_interview_detail',
  deviewId: '4d91c40997e9395b2fc168c89c0a9f31',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.HR_INTERVIEW_FEEDBACK',
  },
  caption: '面试反馈',
  codeName: 'hr_interview_feedback_my_interview_detail',
  height: 100,
  ...
  controls: [
    {
      xdataControlName: 'form',
      codeName: 'my_interview_detail_toolbar',
      controlType: 'TOOLBAR',
      logicName: '我的面试详情_工具栏',
      appDataEntityId: 'web.hr_interview_feedback',
      controlParam: {
        id: 'toolbar',
      },
      modelId: '0436e47beb91bba615584903f6998499',
      modelType: 'PSDETOOLBAR',
      name: 'toolbar',
      id: 'my_interview_detail_toolbar',
    },
    {
      createControlAction: {
                          ...
                          deformTabPages: [
                            {
                              ...
                              deformDetails: [
                                {
                                  appViewId:
                                    'web.hr_interview_feedback_my_interview_detail_base',
                                  parentDataJO: {
                                    srfparentdename: 'HR_INTERVIEW_FEEDBACK',
                  ...
                  deformDetails: [
                          ...
                          deformDetails: [
                            {
                              rawItem: {
                                content:
                                  '<h1 style="text-align: center;"><span style="color: #236fa1;">&middot;&middot;&middot;&middot;&middot;面试&middot;&middot;&middot;&middot;&middot;</span></h1>',
                                contentType: 'HTML',
                                id: 'rawitem6',
                              },
                              codeName: 'rawitem6',
                        ...
                        },
                        {
                          ...
                          deformDetails: [
                            ...
                            },
                            {
                              ...
                              buttonStyle: 'DEFAULT',
                              uiactionId:
                                'add_feedback_manager@hr_interview_feedback',
                              tooltip: '填写反馈',
                            ...
                            },
                            {
                              ...
                              uiactionGroup: {
                                ...
                                appDataEntityId: 'web.hr_interview_feedback',
                                uniqueTag:
                                  'hr_interview_feedback__Usr0829179600',
                                name: '我的面试（更多）',
                                id: 'usr0829179600',
                              },
                              caption: '更多',
                    ...
                    },
                    {
                      ...
                      deformDetails: [
                        {
                          appViewId:
                            'web.hr_applicant_interview_my_interview_calendar_view',
                          navigateParams: [
                            {
      ...
      codeName: 'my_interview_detail_form',
      controlType: 'FORM',
      logicName: '我的面试详情_表单',
      appDataEntityId: 'web.hr_interview_feedback',
      controlParam: {
      ...
      modelId: '85541d05c7893c6144b43fa03ba858e5',
      modelType: 'PSDEFORM_EDITFORM',
      name: 'form',
      id: 'web.hr_interview_feedback.my_interview_detail_form',
    },
    {
      codeName: 'my_interview_detail_datainfobar',
      ...
      name: 'datainfobar',
      id: 'my_interview_detail_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.HR_INTERVIEW_FEEDBACK',
      ...
      caption: '面试反馈',
      codeName: 'my_interview_detail_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'web.hr_interview_feedback',
      controlParam: {},
      name: 'captionbar',
      id: 'my_interview_detail_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  modelId: '8c212de0e3aeacead879771a36aec54e',
  modelType: 'PSAPPDEVIEW',
  name: 'hr_interview_feedbackmy_interview_detail',
  id: 'web.hr_interview_feedback_my_interview_detail',
};
