export default {
  ...
  loadDefault: true,
  deviewCodeName: 'manager_evaluate_view',
  deviewId: '07c94f0df1e3ee025f476c09a64e7d49',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.HR_CANDIDATE_FILTER_DETAIL',
  },
  caption: '筛选候选人明细',
  codeName: 'hr_candidate_filter_detail_manager_evaluate_view',
  ...
  controls: [
    {
      ...
      xdataControlName: 'form',
      codeName: 'manager_evaluate_view_toolbar',
      controlType: 'TOOLBAR',
      ...
      name: 'toolbar',
      id: 'manager_evaluate_view_toolbar',
    },
    {
      createControlAction: {
    ...
    {
      codeName: 'manager_evaluate_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'manager_evaluate_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.HR_CANDIDATE_FILTER_DETAIL',
      ...
      caption: '筛选候选人明细',
      codeName: 'manager_evaluate_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'web.hr_candidate_filter_detail',
      controlParam: {},
      name: 'captionbar',
      id: 'manager_evaluate_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '6aec6c1fb4dbf718bef323048c432b13',
  modelType: 'PSAPPDEVIEW',
  name: 'hr_candidate_filter_detailmanager_evaluate_view',
  id: 'web.hr_candidate_filter_detail_manager_evaluate_view',
};
