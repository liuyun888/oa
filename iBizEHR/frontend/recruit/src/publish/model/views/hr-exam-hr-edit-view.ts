export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'hr_edit_view',
  deviewId: '7058515271b710b7e010bb274e9ed604',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.HR_EXAM',
  },
  caption: '考试/评测详情',
  codeName: 'hr_exam_hr_edit_view',
  height: 100,
  ...
  controls: [
    {
      xdataControlName: 'form',
      codeName: 'hr_edit_view_toolbar',
      controlType: 'TOOLBAR',
      logicName: '考试/评测详情（用人经理）_工具栏',
      appDataEntityId: 'web.hr_exam',
      controlParam: {
        id: 'toolbar',
      },
      modelId: '7612eb85b37180b51f40df4ba145c004',
      modelType: 'PSDETOOLBAR',
      name: 'toolbar',
      id: 'hr_edit_view_toolbar',
    },
    {
      createControlAction: {
                      ...
                      deformTabPages: [
                        {
                          ...
                          deformDetails: [
                            {
                              appViewId: 'web.hr_exam_candidate_base_edit_view',
                              parentDataJO: {
                                srfparentdename: 'HR_EXAM',
                  ...
                  defdgroupLogics: [
                    {
                      ...
                      relatedDetailNames: ['finish_time'],
                      groupOP: 'AND',
                      defdlogics: [
                        {
                          condOP: 'ISNULL',
                          defdname: 'finish_time',
                          logicType: 'SINGLE',
                        },
                      ],
                      logicType: 'GROUP',
      ...
      codeName: 'hr_edit_view_form',
      controlType: 'FORM',
      logicName: '考试/评测详情（用人经理）_表单',
      appDataEntityId: 'web.hr_exam',
      controlParam: {
        id: 'form',
      },
      modelId: 'd68b976c81f5fdc969328d427f2e83e2',
      modelType: 'PSDEFORM_EDITFORM',
      name: 'form',
      id: 'web.hr_exam.hr_edit_view_form',
    },
    {
      codeName: 'hr_edit_view_datainfobar',
    ...
    },
    {
      ...
      caption: '考试/评测详情',
      codeName: 'hr_edit_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'web.hr_exam',
      controlParam: {},
      name: 'captionbar',
      id: 'hr_edit_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '62477338ef43c8649c242eeb1b4c2d1a',
  modelType: 'PSAPPDEVIEW',
  name: 'hr_examhr_edit_view',
  id: 'web.hr_exam_hr_edit_view',
};
