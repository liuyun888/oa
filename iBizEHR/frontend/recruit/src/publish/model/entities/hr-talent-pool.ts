export default {
  ...
  appDEMethodDTOs: [
    {
      ...
      sourceType: 'DE',
      type: 'DEFAULT',
      id: 'hr_talent_pool_dto',
    },
    {
      codeName: 'hr_talent_pool_filter_dto',
      appDEMethodDTOFields: [
        {
          codeName: 'n_id_eq',
          logicName: '标识',
  ...
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'hr_talent_pool_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'hr_talent_pool_filter_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
  ...
  codeName: 'hr_talent_pool',
  deapicodeName: 'hr_talent_pool',
  deapicodeName2: 'hr_talent_pools',
  deapitag: 'HR_TALENT_POOL',
  dataAccCtrlArch: 1,
  dataAccCtrlMode: 1,
  enableUIActions: 15,
  keyAppDEFieldId: 'id',
  lnlanguageRes: {
    lanResTag: 'DE.LNAME.HR_TALENT_POOL',
  },
  logicName: '人才库',
  ...
  major: true,
  name: 'HR_TALENT_POOL',
  id: 'web.hr_talent_pool',
  codeName2: 'hr_talent_pools',
  requestPaths: [],
};
