...
export declare const IBizListTreeControl: import("@ibiz-template/vue3-util").TypeWithInstall<import("vue").DefineComponent<{
    ...
    c: import("./list-tree.controller").ListTreeController<import("@ibiz/model-core").IDETree, import("@ibiz-template/runtime").ITreeState, import("@ibiz-template/runtime").ITreeEvent>;
    ...
    treeviewRef: import("vue").Ref<import("@ibiz-template/core").IApiData | null>;
    treeNodeTextInputRef: import("vue").Ref<import("@ibiz-template/core").IApiData | null>;
    treeData: import("vue").ComputedRef<import("@ibiz-template/runtime").IApiTreeNodeData[]>;
    ...
    loadData: (item: import("@ibiz-template/core").IApiData, callback: (nodes: import("@ibiz-template/core").IApiData[]) => void) => Promise<void>;
    ...
    updateNodeExpand: (data: import("@ibiz-template/core").IApiData, expanded: boolean) => void;
    onInput: (value: string) => void;
    allowDrop: (draggingNode: import("@ibiz-template/core").IApiData, dropNode: import("@ibiz-template/core").IApiData, type: import("element-plus/es/components/tree/src/tree.type").AllowDropType) => boolean;
    allowDrag: (draggingNode: import("@ibiz-template/core").IApiData) => boolean;
    handleDrop: (draggingNode: import("@ibiz-template/core").IApiData, dropNode: import("@ibiz-template/core").IApiData, dropType: import("element-plus/es/components/tree/src/tree.type").NodeDropType) => void;
