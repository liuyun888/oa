...
"use strict";
class ModelImportProvider extends UIActionProviderBase {
  async execAction(action, args) {
    ...
    ibiz.modelClipboardImportView.updateParams({
      codeName: entity.codeName,
      srfmodelv2scope: resultContext.srfmodelv2scope
    });
    const overlay = ibiz.overlay.createDrawer(
      (modal) => {
        return h(resolveComponent("IBizModelClipboardImportView"), {
          modal,
