...
export declare abstract class CellProviderImpl<C> implements X6CellServiceProvider<C, IDataEntity> {
     ...
     * @memberof CellProviderImpl
     */
    refresh(context: IContext, params: IParams): Promise<void>;
    ...
    abstract createCell(data: X6CellDataProvider<IDataEntity>, designMode?: string): Cell.Metadata;
    /**
     * 获取当前节点对应的应用实体模型
     *
     * @author chitanda
