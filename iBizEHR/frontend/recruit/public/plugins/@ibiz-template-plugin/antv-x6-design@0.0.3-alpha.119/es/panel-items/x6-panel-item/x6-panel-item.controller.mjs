...
class X6PanelItemController extends PanelItemController {
  ...
  async onInit() {
    ...
    this.view.evt.on("onSaveSuccess", async () => {
      ...
      if (this.showLogicHolder) {
        const logicHolder = ((_a2 = this.view.state.data) == null ? void 0 : _a2.logicholder) || 3;
    ...
    if (this.showLogicHolder) {
      this.state.logicHolder = ((_a = this.view.state.data) == null ? void 0 : _a.logicholder) || 3;
  ...
  async onDataUpdate(msg) {
    ...
    const data = msg.data;
    if (data.srfdecodename === this.majorEntity.codeName && data.srfkey === ((_a = this.view.state.data) == null ? void 0 : _a.srfkey)) {
