...
class X6CellController {
  ...
  onMessageChange(msg) {
    ...
    if (msg.data && typeof msg.data === "object") {
      ...
      const data = (_a = view == null ? void 0 : view.state) == null ? void 0 : _a.data;
      const entity = msg.data;
      if (data && data.srfkey === id && data.srfdecodename && data.srfdecodename === entity.srfdecodename) {
        return;
      }
