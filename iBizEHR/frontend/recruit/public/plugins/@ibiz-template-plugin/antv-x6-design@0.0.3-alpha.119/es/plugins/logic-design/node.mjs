...
class NodeProviderImpl extends CellProviderImpl {
  ...
  async copy(context, params, node) {
  ...
  createCell(data) {
    if (data.type === "TEXTAREA")
      return this.createRemarkCell(data);
    ...
    return {
      ...
      type: data.type,
      data,
      inputNum: codeItem == null ? void 0 : codeItem.intput_cnt,
      outputNum: codeItem == null ? void 0 : codeItem.output_cnt
    };
  }
  createRemarkCell(data) {
    return {
      data,
      x: data.x,
      y: data.y,
