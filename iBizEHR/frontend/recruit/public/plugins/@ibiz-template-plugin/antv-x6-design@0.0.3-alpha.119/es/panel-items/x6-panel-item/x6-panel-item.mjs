...
import { LogicHolder } from '../../components/logic-holder/logic-holder.mjs';
...
var X6PanelItem = /* @__PURE__ */ defineComponent({
  ...
  render() {
    ...
    }, [this.controller.showLogicHolder ? createVNode(LogicHolder, {
      "value": this.controller.state.logicHolder
    }, null) : null, createVNode(ScaleToolbar, {
      "controller": this.$props.controller,
      "class": this.ns.is("right", this.controller.showLogicHolder)
