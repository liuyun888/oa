export default {
  ...
  caption: '员工计划',
  codeName: 'mail_activity_planmulti_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ehrapp.mail_activity_planmain_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ehrapp.mail_activity_planmain_view',
    ...
    controls: [
      {
        ...
        itemLayoutPanel: {
          ...
          id: 'ehrapp.mail_activity_plan.auto47523176',
        },
        dedataViewDataItems: [
          {
            appDEFieldId: 'id',
        ...
        name: 'dataview',
        id: 'ehrapp.mail_activity_plan.mail_activity_plan_info',
      },
      {
        groupMode: 'SINGLE',
        searchBarGroups: [
        ...
        name: 'searchbar',
        id: 'ehrapp.mail_activity_plan.search_bar',
      },
      {
        ...
        name: 'searchform',
        id: 'ehrapp.mail_activity_plan.main2',
      },
      {
        detoolbarItems: [
          {
      ...
      },
      {
        ...
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ehrapp.mail_activity_plan.hr_main',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.MAIL_ACTIVITY_PLAN',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '91e98282906886a958f8db9207ec2686',
  modelType: 'PSAPPDEVIEW',
  name: 'mail_activity_planmulti_data_view',
  id: 'ehrapp.mail_activity_planmulti_data_view',
};
