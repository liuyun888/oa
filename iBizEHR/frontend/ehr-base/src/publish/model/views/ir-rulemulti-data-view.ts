export default {
  ...
  caption: '规则',
  codeName: 'ir_rulemulti_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ehrapp.ir_rulemain_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ehrapp.ir_rulemain_view',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'e0f5d2fb08bb9b25c0d975943000ee65',
  modelType: 'PSAPPDEVIEW',
  name: 'ir_rulemulti_data_view',
  id: 'ehrapp.ir_rulemulti_data_view',
};
