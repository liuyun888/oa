export default {
  ...
  caption: '部门',
  codeName: 'hr_departmentmulti_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ehrapp.hr_departmentmain_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ehrapp.hr_departmentmain_view',
    ...
    controls: [
      {
        ...
        name: 'searchbar',
        id: 'ehrapp.hr_department.search_bar',
      },
      {
        aggMode: 'NONE',
      ...
      },
      {
        ...
        itemLayoutPanel: {
                      ...
                      panelItems: [
                        {
                          editor: {
                            ...
                            valign: 'MIDDLE',
                            wrapMode: 'NOWRAP',
                            appCodeListId: 'ehrapp.hr__hr_employee',
          ...
          id: 'ehrapp.hr_department.ab21d9c0f00ab5cb106',
        },
        minorSortDir: 'DESC',
        minorSortAppDEFieldId: 'write_date',
        dedataViewDataItems: [
        ...
        name: 'dataview',
        id: 'ehrapp.hr_department.department_info',
      },
      {
        detoolbarItems: [
          {
      ...
      },
      {
        ...
        detreeNodes: [
          ...
          },
          {
            ...
            navAppViewId: 'ehrapp.hr_departmentmain_view',
            nodeType: 'children',
            appDataEntityId: 'ehrapp.hr_department',
            navigateContexts: [
              {
            ...
            controlRenders: [
              {
                layoutPanel: {
                  ...
                  modelType: 'PSSYSVIEWPANEL',
                  name: 'childen_layout',
                  id: 'ehrapp.hr_department.department_chart_node_panel',
                },
              ...
              },
              {
                layoutPanel: {
                  ...
                  id: 'ehrapp.hr_department.dept_active_node_panel',
                },
                renderType: 'LAYOUTPANEL',
        ...
        name: 'hierarchy',
        id: 'ehrapp.hr_department.department_hierarchy',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.HR_DEPARTMENT',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'b98197392c31b7136e34ad7f2fcd3d94',
  modelType: 'PSAPPDEVIEW',
  name: 'hr_departmentmulti_data_view',
  id: 'ehrapp.hr_departmentmulti_data_view',
};
