export default {
  ...
  caption: '用户所属群组',
  codeName: 'res_groupsmulti_data_view_user',
    ...
    controls: [
      {
        ...
        codeName: 'multi_data_view_usertoolbar',
        controlType: 'TOOLBAR',
        ...
        name: 'toolbar',
        id: 'multi_data_view_usertoolbar',
      },
      {
      ...
      },
      {
        ...
        name: 'searchbar',
        id: 'ehrapp.res_groups.search_bar_user',
      },
      {
        aggMode: 'NONE',
      ...
      },
      {
        ...
        caption: '用户所属群组',
        codeName: 'multi_data_view_usercaptionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'ehrapp.res_groups',
        controlParam: {},
        name: 'captionbar',
        id: 'multi_data_view_usercaptionbar',
      },
    ],
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '3e70742f1b569154f8564487008dc607',
  modelType: 'PSAPPDEVIEW',
  name: 'res_groupsmulti_data_view_user',
  id: 'ehrapp.res_groupsmulti_data_view_user',
};
