export default {
  ...
  caption: '资源',
  codeName: 'resource_resourcemulti_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ehrapp.resource_resourcemain_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ehrapp.resource_resourcemain_view',
    ...
    controls: [
      {
        ...
        name: 'searchbar',
        id: 'ehrapp.resource_resource.search_bar',
      },
      {
        detoolbarItems: [
          {
      ...
      },
      {
        ...
        degridColumns: [
          ...
          },
          {
            ...
            excelCaption: '类型',
            appCodeListId: 'ehrapp.resource__resource_resource_resource_type',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '9b5d3dcd28bc22144a29d824914361a3',
  modelType: 'PSAPPDEVIEW',
  name: 'resource_resourcemulti_data_view',
  id: 'ehrapp.resource_resourcemulti_data_view',
};
