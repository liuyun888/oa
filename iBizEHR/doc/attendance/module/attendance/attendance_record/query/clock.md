## clock(clock) <!-- {docsify-ignore-all} -->
...
### 查询连接
* **ATTENDANCE_RECORD_DETAIL存在1:N（EXISTS (SELECT)）DER1N_ATTENDANCE_RECORD_DETAIL_ATTENDANCE_RECORD_RECORD_ID**<br>
连接关系：[DER1N_ATTENDANCE_RECORD_DETAIL_ATTENDANCE_RECORD_RECORD_ID](der/DER1N_ATTENDANCE_RECORD_DETAIL_ATTENDANCE_RECORD_RECORD_ID)<br>
连接实体：[考勤记录](module/attendance/attendance_record)<br>
