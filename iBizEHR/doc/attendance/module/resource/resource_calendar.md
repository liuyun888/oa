...
|Get|Get|内置方法|默认|不支持||||
|GetDraft|GetDraft|内置方法|默认|不支持|[附加操作](index/action_logic_index#resource_calendar_GetDraft)|||
|Remove|Remove|内置方法|默认|支持||||
|Save|Save|内置方法|默认|不支持||||
|Update|Update|内置方法|默认|不支持||||
|补充草稿|fillDraft|[实体处理逻辑](module/resource/resource_calendar/logic/fillDraft "补充草稿")|默认|不支持||||
