## null(DER1N_ATTENDANCE_CHECKIN_DEVICE_ATTENDANCE_DEVICE_DEVICE_ID) <!-- {docsify-ignore-all} -->
...
* [考勤设备关联(ATTENDANCE_CHECKIN_DEVICE)](module/attendance/attendance_checkin_device)
