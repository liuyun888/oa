## null(DER1N_ATTENDANCE_GPS_LOCATION_ATTENDANCE_RULE_RULE_ID) <!-- {docsify-ignore-all} -->
...
* [GPS定位配置(ATTENDANCE_GPS_LOCATION)](module/attendance/attendance_gps_location)
