...
|<el-row justify="space-between"><el-col :span="20">attendances</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|Object|null|
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/resource_calendars/fill_draft" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`NONE`
