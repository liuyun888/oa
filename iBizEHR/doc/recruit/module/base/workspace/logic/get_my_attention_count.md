...
state "准备参数" as PREPAREPARAM1  [[$./get_my_attention_count#prepareparam1 {"准备参数"}]]
state "实体行为" as DEACTION1  [[$./get_my_attention_count#deaction1 {"实体行为"}]]
...
调用实体 [候选人(HR_CANDIDATE)](module/hr/hr_candidate.md) 行为 [获取工作台我的关注数(get_my_attention_count)](module/hr/hr_candidate#行为) ，行为参数为`candidate`
