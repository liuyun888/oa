...
调用实体 [分析报表(REPORT)](module/base/report.md) 行为 [Update](module/base/report#行为) ，行为参数为`Default(传入变量)`
...
|    中文名   |    代码名    |  数据类型    |  实体   |备注 |
| --------| --------| -------- | -------- | --------   |
|传入变量(<i class="fa fa-check"/></i>)|Default|数据对象|[分析报表(REPORT)](module/base/report.md)||
