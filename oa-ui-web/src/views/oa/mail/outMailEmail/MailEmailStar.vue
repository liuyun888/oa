<template>
	<section class="page-container border padding">
      ...
      <el-button icon="el-icon-s-promotion" style="margin-left: 0;margin-right: 13px;" v-loading="load.receive"
      ...
      <el-table :height="tableHeight" ref="procdefsTable" :data="mailEmails" @sort-change="sortChange"
        ...
        <el-table-column prop="cc" label="抄送人" show-overflow-tooltip min-width="80"></el-table-column>
