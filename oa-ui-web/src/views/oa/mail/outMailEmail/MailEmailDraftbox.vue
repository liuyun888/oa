<template>
	<section class="page-container border padding">
      ...
      <el-button icon="el-icon-s-promotion" style="margin-left: 0;margin-right: 13px;" @click="showAdd('1')">发送邮件
      </el-button>
      <!-- <el-button type="primary" @click="showAdd('0')">添加内部邮件</el-button> -->
      ...
      <el-table :height="tableHeight" ref="procdefsTable" :data="mailEmails" @sort-change="sortChange"
        ...
        <el-table-column prop="sendEmail" show-overflow-tooltip label="发件邮箱" min-width="80"></el-table-column>
        ...
        <el-table-column label="操作" width="200" fixed="right">
          <template slot-scope="scope">
            <el-button @click.stop="showEdit( scope.row,scope.$index)" icon="el-icon-edit"></el-button>
