  ...
  <section class="page-container border padding">
    <el-row class="page-header">
      ...
      <el-button type="primary" icon="el-icon-search" style="margin-right: 13px;" v-loading="load.list"
                 :disabled="load.list==true" v-on:click="searchMailEmails">查询
      </el-button>
    ...
    <el-row class="page-main padding-top">
      ...
      <el-table :height="tableHeight" ref="procdefsTable" :data="mailEmails" @sort-change="sortChange"
        ...
        <!-- <el-table-column prop="content" label="正文" min-width="80" ></el-table-column>
				<el-table-column prop="userId" label="发件人id" min-width="80" ></el-table-column>-->
        ...
        <el-table-column prop="sendTime" show-overflow-tooltip label="发送时间" min-width="80"></el-table-column>
        ...
        <el-drawer title="邮件详情" :visible.sync="emailInfoVisible" direction="rtl" size="50%">
          <div>
            ...
            <el-row>
              ...
              <el-col v-if="emailInfo.status == '1'" :span="20">发送成功</el-col>
            </el-row>
            <el-row>
