				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="相对方编号" prop="cpSn">
							<el-input v-model="editForm.cpSn"> </el-input>
						</el-form-item> 
					</el-col>
				</el-row>
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="相对方简称" prop="cpShort">
							<el-input v-model="editForm.cpShort" ></el-input>
						</el-form-item> 
					</el-col>

					<el-col :span="12">
						<el-form-item label="相对方级别" prop="cpLevel">
							<el-select  v-model="editForm.cpLevel" placeholder="请选择">
								<el-option
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="相对方类型" prop="cpTypeName">
							<el-select @change="optionsChange($event,'type')" v-model="editForm.cpTypeName" placeholder="请选择">
								<el-option
					...
					<el-col :span="12">
						<el-form-item label="相对方状态" prop="cpStatus">
							<el-select  v-model="editForm.cpStatus" placeholder="请选择">
								<el-option
				...
				<el-row>
					<el-col :span="8">
						<el-form-item label="相对方行业" prop="cpIndustryName">
							<!-- <el-input v-model="editForm.cpIndustryName" ></el-input> -->
							<el-select @change="optionsChange($event,'industry')" v-model="editForm.cpIndustryName" placeholder="请选择">
								<el-option
					...
					<el-col :span="8">
						<el-form-item label="所在区域" prop="cpRegionName">
							<el-select @change="optionsChange($event,'region')" v-model="editForm.cpRegionName" placeholder="请选择">
								<el-option
				...
				<el-row>
					<el-col :span="24">
						<el-form-item label="相对方网址" prop="cpWebsite">
							<el-input v-model="editForm.cpWebsite"></el-input>
						</el-form-item> 
					</el-col>
				</el-row>
				...
				<el-row>
					<el-col :span="24">
						<el-form-item label="相对方简介" prop="cpDesc">
							<el-input type="textarea" rows="4" v-model="editForm.cpDesc" ></el-input>
						</el-form-item> 
					</el-col>
				</el-row>
				...
				<el-row>
					...
					<el-col :span="8">
						<el-form-item label="注册信息" prop="cpZcxx">
							<el-input v-model="editForm.cpZcxx"></el-input>
						</el-form-item> 
					</el-col>
				...
				<el-row>
					<el-col :span="8">
						<el-form-item label="注册资本" prop="cpZczb">
							<el-input v-model="editForm.cpZczb"  ></el-input>
						</el-form-item> 
					</el-col>

					<el-col :span="8">
						<el-form-item label="注册时间" prop="cpZcsj">
							<el-input v-model="editForm.cpZcsj" ></el-input>
						</el-form-item> 
					</el-col>

					<el-col :span="8">
						<el-form-item label="单位状态" prop="cpDwztName">
							<el-select @change="optionsChange($event,'copmanystatus')" v-model="editForm.cpDwztName" placeholder="请选择">
								<el-option
				...
				<el-row>
					<el-col :span="8">
						<el-form-item label="单位电话" prop="cpPhone">
							<el-input v-model="editForm.cpPhone"></el-input>
						</el-form-item> 
					</el-col>

					<el-col :span="8">
						<el-form-item label="邮箱" prop="cpEmail">
							<el-input v-model="editForm.cpEmail"  ></el-input>
						</el-form-item> 
					</el-col>

					<el-col :span="8">
						<el-form-item label="传真" prop="cpFax">
							<el-input v-model="editForm.cpFax" ></el-input>
						</el-form-item> 
					</el-col>
				</el-row>
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="结算方式" prop="cpClearWayName">
							<el-select @change="optionsChange($event,'way')" v-model="editForm.cpClearWayName" placeholder="请选择">
								<el-option
				...
				<el-row> 
					<el-col :span="12">
						<el-form-item label="币种" prop="cpCurrency">
							<el-input v-model="editForm.cpCurrency" ></el-input>
						</el-form-item> 
					</el-col>
...
<script>
	...
	import { editCounterparty } from '@/api/oa/ht/counterparty';
	...
	export default { 
		...
		watch: {
	      'counterparty':function( counterparty ) {
				...
				this.linkManData = this.counterparty.linkmanList;
				this.linkManData.forEach(l => {
					l.validate = {
					oneShow: false,
					twoShow: false,
					threeShow: false,
		...
		methods: {
				...
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						this.$confirm('确认提交吗？', '提示', {}).then(() => { 
							...
							editCounterparty(params).then((res) => {
								this.load.add=false
			...
			optionsChange(data, kind) {
				...
				switch(kind) {
					case 'type' :
						this.editForm.cpType = value;
						this.editForm.cpTypeName = label;
					break;
					case 'industry':
						this.editForm.cpIndustry = value;
						this.editForm.cpIndustryName = label;
					break;
					case 'region':
						this.editForm.cpRegion = value;
						this.editForm.cpRegionName = label;
					break;
					case 'way':
						this.editForm.cpClearWay = value;
						this.editForm.cpClearWayName = label;
					break;
					case 'copmanystatus':
						this.editForm.cpDwzt = value;
						this.editForm.cpDwztName = label;
					break;
				}
			},
			...
			getAddressData(data, type) {
				...
				this.editForm.cpProvince = data.province;
				this.editForm.cpProvinceCode = data.provinceCode;
				this.editForm.cpCity = data.city;
				this.editForm.cpCityCode = data.cityCode;
				this.editForm.cpDistrict = data.district;
				this.editForm.cpDistrictCode = data.districtCode;
				this.addressName = this.editForm.cpProvince + "/" + this.editForm.cpCity + "/" + this.editForm.cpDistrict;
			},
		...
		mounted() {
			this.editForm=Object.assign(this.editForm, this.counterparty);
			this.linkManData = this.counterparty.linkmanList;
			this.linkManData.forEach(l => {
					l.validate = {
					oneShow: false,
