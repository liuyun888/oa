				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="发票金额" prop="amount">
							<el-input-number v-model="editForm.amount" :min="0" disabled></el-input-number>
						</el-form-item> 
					</el-col>
				</el-row>
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="发票开具日期" prop="openDate">
							<el-date-picker type="date" v-model="editForm.openDate"></el-date-picker>
						</el-form-item> 
					</el-col>
				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="收票日期" prop="receiveDate">
							<el-date-picker type="date" v-model="editForm.receiveDate"  ></el-date-picker>
						</el-form-item> 
					</el-col>
				</el-row>
...
<script>
	...
	import { editContractInvoiceReceive } from '@/api/oa/ht/contractInvoiceReceive';
				...
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						this.$confirm('确认提交吗？', '提示', {}).then(() => { 
							...
							editContractInvoiceReceive(params).then((res) => {
