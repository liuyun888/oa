   ...
   <section >
      ...
      <div class="continer" @contextmenu.prevent="onContextmenu">
         <div class="header">
            ...
            <div class="right">
               <div class="btn2">
                  <el-button v-loading="load.add" @click="editSubmit('1')" size="mini" type="primary">提交</el-button>
                  <el-button @click="editSubmit('0')" size="mini" type="primary">保存</el-button>
            ...
            <div class="content">
               ...
               <el-form  size="mini" :model="editForm"  label-width="100px" :rules="editFormRules" ref="editForm">
                  ...
                  <el-row>
                     ...
                     <el-col :span="12">
                        <el-form-item label="客户经理">
                           <el-input suffix-icon="el-icon-search" @focus="visibleUserSelect=true" v-model="editForm.reqUserName"> </el-input>
                        </el-form-item>
                     </el-col>

                     <el-col :span="12">
                        <el-form-item label="部门">
                           <el-input suffix-icon="el-icon-search" @focus="visibleDeptSelect=true" v-model="editForm.reqDeptName"></el-input>
                        </el-form-item>
                     </el-col>
                  ...
                  <el-row>
                     <el-col :span="12">
                        <el-form-item label="创建日期">
                          	<el-date-picker v-model="editForm.reqDate" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" placeholder="选择日期" disabled></el-date-picker>
                        </el-form-item>
                     </el-col> 
                     <el-col :span="12">
                        <el-form-item label="成本中心" prop="cbCenterId"> 
                           <el-input suffix-icon="el-icon-search" @focus="visibleCbDeptSelect=true" v-model="editForm.cbCenterName"></el-input>
                        </el-form-item>
                     </el-col> 
                  </el-row>
                  ...
                  <el-row>
                     ...
                     <el-col :span="12">
                        <el-form-item label="合同金额">
                           <el-input  @change="amountChange" v-model="editForm.htAmount"></el-input>
                        </el-form-item>
                     </el-col>
                  </el-row>
                  ...
                  <el-row>
                     <el-col :span="24">
                        <el-form-item label="合同重要条款">
                           <el-input type="textarea" v-model="editForm.htImportantClause" :rows="4"></el-input>
                        </el-form-item>
                     </el-col>
                  </el-row>
                  ...
                  <el-row>
                     <el-col :span="24">
                        <el-form-item label="合同说明">
                           <el-input type="textarea" v-model="editForm.htDemand" :rows="4"></el-input>
                        </el-form-item>
                     </el-col>
                  </el-row>
                  ...
                  <el-row>
                     <el-col :span="24">
                        <el-form-item label="客户名称">
                           <el-input suffix-icon="el-icon-search" v-model="editForm.cpName" @focus="counterpartyVisible=true" ></el-input>
                        </el-form-item>
                     </el-col> 
                  </el-row>
                  ...
                  <el-row>
                     <el-col :span="12">
                        <el-form-item label="客户级别">
                           <el-input v-model="editForm.cpLevel" ></el-input>
                        </el-form-item>
                     </el-col>
                     <el-col :span="12">
                        <el-form-item label="客户类型">
                           <el-input v-model="editForm.cpType" ></el-input>
                        </el-form-item>
                     </el-col>
                  </el-row>
                 ...
                 <div style="margin: 20px">
                  ...
                  <line-components text="关联项目"></line-components> 
                  <el-table size="small" border :data="projectData" stripe>
                     <el-table-column
                           label="序号"
                           type="index"
                           width="50">
                     </el-table-column> 
                     <el-table-column prop="projectId" align="center" label="项目编号" width="" >   
                        <template slot-scope="row">
                              <el-input  size="mini" v-model="projectData[row.$index].projectId"> </el-input>
                           </template> 
                     </el-table-column> 
                     <el-table-column prop="projectName" align="center" label="项目名称"  width=""> 
                        <template slot-scope="row">
                              <el-input  size="mini" v-model="projectData[row.$index].projectName"> </el-input>
                           </template>
                     </el-table-column> 
                     <el-table-column align="center"  width="80">
                           <template slot="header">
                              <i class="el-icon-circle-plus-outline"  @click="addRow('project');"></i>
                           </template>
                           <template slot-scope="row">
                              <i class="el-icon-remove-outline" @click="delRow('project', row.$index)"></i>
                           </template>
                        </el-table-column>
                  </el-table>
                  ...
                  <line-components text="付款约定"></line-components>
                  ...
                  <el-table  size="small" border :data="conditionData" stripe>
                     ...
                     <el-table-column  align="center" label="付款条件" width="" >
                           <template slot-scope="row">
                        <el-input size="mini" v-model="conditionData[row.$index].conditionTiaoJian"> </el-input>
                           </template>
                     </el-table-column>

                     <el-table-column  align="center" label="付款比例(%)"  width="">
                           <template slot-scope="row">
                     ...
                     <el-table-column  align="center" label="付款金额"  width="">
                           <template slot-scope="row">
                     ...
                     <el-table-column  align="center" label="备注"  width="">
                           <template slot-scope="row">
                              <el-input size="mini"  v-model="conditionData[row.$index].conditionRemark"></el-input>
                           </template>
                     </el-table-column>
...
import { editContractDraft } from '@/api/oa/ht/contractDraft';
...
export default {
   ...
   props:['visible', 'contractDraft'],
   watch: {

      'contractDraft':function( contractDraft ) {
            this.editForm = contractDraft;
       },
   ...
   methods: {
      ...
      transferData(data) {
         ...
         data.projectList=this.projectData;
         return data;
      },
      ...
      getCounterparty(data) {
         ...
         this.editForm.cpFddb = data.cpFddb;
         this.editForm.cpLevel = data.cpLevel;
         this.editForm.cpType = data.cpType;
         this.editForm.cpAddress = data.cpAddress;
         this.editForm.cpOpenBank = data.cpOpenBank;
         this.editForm.cpBankAccount = data.cpBankAccount;
         this.editForm.linkName = data.linkmanList[0].linkName;
         this.editForm.linkPhone = data.linkmanList[0].linkPhone;
      },

      getDeptData(data) {
         this.visibleDeptSelect = false;
         this.editForm.reqDeptId = data.deptid;
         this.editForm.reqDeptName = data.deptName;
      }, 
      getCbDeptData(data) {
      ...
      getUserData(data) {
         ...
         this.editForm.reqUserId = data[0].userid;
         this.editForm.reqUserName = data[0].username;
      },
      ...
      amountChange() {
         this.editForm.htAmount = this.validateAmount(this.editForm.htAmount);
      },
      ...
      initData() {
        this.editForm=Object.assign(this.editForm, this.contractDraft);
        this.cbData = this.contractDraft.cbList;
        this.conditionData = this.contractDraft.conditionList;
        this.proData = [];
        this.thirdPartyData = [];
        //产品数据分解
        this.contractDraft.productList.forEach(item => {
            item.isThirdParty === '0' ?  this.proData.push(item) : this.thirdPartyData.push(item);
        })
        if(this.thirdPartyData.length > 0) this.isThirdParty = '1';
      },
