         ...
         <div class="nav">
            ...
            <div class="content">
               <el-form  size="mini" :model="editForm"  label-width="100px" :rules="editFormRules" ref="editForm">
                  ...
                  <el-row>
                     <el-col :span="12">
                        <el-form-item label="采购需求说明" prop="htDemand">
                  ...
                  <line-components text="供应商信息"></line-components>
                  
                  
                  <el-row>
                     <el-col :span="12">
                        <el-form-item label="供应商名称" prop="cpName">
                  ...
                  <line-components text="采购信息"></line-components>
...
export default {
   ...
   watch: {
      ...
      editForm: {
         handler: function(val, oldval) {
            val.htAmount = this.validateAmount(val.htAmount)
         },
         deep:true
      }
   },
   ...
   methods: {
      ...
      initData() {
            ...
            this.proData = this.contractDraft.productList;
      },
