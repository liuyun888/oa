               ...
               <el-form  size="mini" :model="addForm"  label-width="100px" :rules="addFormRules" ref="addForm">
                 ...
                 <div style="margin: 20px">
                  ...
                  <el-table size="small" border :data="projectData" stripe>
                   ...
                   <line-components text="成本估算"></line-components> 
...
export default {
   ...
   data() {
      ...
      return {
         load: {add: false},
         addForm: {
				id:'',title:'',reqUserId:'',reqUserName:'',reqDeptId:'',reqDeptName:'',reqDate:'',htName:'',htParty:'',htPartyName:'',htSn:'',htBeginDate:'',htAmount:'',htImportantClause:'',htDemand:'',cpId:'',cpName:'',cpFddb:'',cpLevel:'',cpType:'',cpAddress:'',cpOpenBank:'',cpBankAccount:'',linkName:'',linkPhone:'',htParentType:'',htType:'',isUseMoban:'',fanbenId:'',status:''
			},
         //合同标的
         proData: [],  
         //成本数据
   ...
   methods: {
      ...
      initData() {
         ...
         //设置标题
         this.addForm.title = '工程施工合同-' + this.userInfo.username + "-" + util.formatDate(new Date(), 'yyyy-MM-dd');
         //设置合同名称
         this.addForm.htName = '工程施工合同';

         //设置默认合同编号 合同类型+年月日
         this.addForm.htSn = "XMHT" + util.formatDate(new Date(), "yyyyMMddHHmmss");
