		 ...
		 <el-row class="page-container border padding"> 
			<el-form :model="addForm"  label-width="120px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="会议室类型" prop="name">
					<el-input v-model="addForm.name" placeholder="会议室类型" ></el-input>
				</el-form-item> 
...
<script>
	...
	import { addMeetBoardroomType } from '@/api/oa/meet/meetBoardroomType';
	...
	export default { 
		...
		watch: {
	      'meetBoardroomType':function( meetBoardroomType ) {
	        this.addForm = meetBoardroomType;
	      },
		...
		methods: {
			...
			//新增提交MeetBoardroomType meet_boardroom_type 父组件监听@submit="afterAddSubmit"
			addSubmit: function () {
				...
				this.$refs.addForm.validate((valid) => {
					if (valid) {
						...
						this.$confirm('确认提交吗？', '提示', {}).then(() => { 
							...
							addMeetBoardroomType(params).then((res) => {
								this.load.add=false
		...
		mounted() {
			this.addForm=Object.assign(this.addForm, this.meetBoardroomType);  
			/**在下面写其它函数***/
