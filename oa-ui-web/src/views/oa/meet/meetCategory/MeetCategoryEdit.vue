     ...
     <el-row class="page-container border padding">
      <el-form :model="editForm" label-width="120px" :rules="editFormRules" ref="editForm">
        ...
        <el-form-item label="审批工作流" prop="flow">
          <el-input v-model="editForm.flow" placeholder="审批工作流"></el-input>
        </el-form-item>
        ...
        <el-form-item style="display:none" label="新增时间" prop="createTime">
          <el-date-picker type="date" placeholder="选择日期" v-model="editForm.createTime"
            value-format="yyyy-MM-dd HH:mm:ss" format="yyyy-MM-dd"></el-date-picker>
        </el-form-item>
        <el-form-item>
          <el-col>
  ...
  export default {
    ...
    data() {
      return {
        ...
        //编辑界面数据  MeetCategory meet_category
        editForm: {
          id: '',
          name: '',
          flow: '',
    ...
    methods: {
      ...
      //编辑提交MeetCategory meet_category父组件监听@submit="afterEditSubmit"
      editSubmit: function() {
        this.$refs.editForm.validate((valid) => {
          if (valid) {
            this.$confirm('确认提交吗？', '提示', {}).then(() => {
              ...
              editMeetCategory(params).then((res) => {
    ...
    mounted() {
      this.editForm = Object.assign(this.editForm, this.meetCategory);
    }
  }
</script>
