<template>
	<section class="page-container border padding">
		...
		<el-row class="page-main padding-top"> 
			...
			<el-dialog title="编辑调拨单" center :fullscreen="true" :visible.sync="editFormVisible" @close="addClose" :close-on-click-modal="false">
				  <asset-reallocation-edit ref="assetReceive" :asset-receive="editForm" :visible="editFormVisible" @cancel="editFormVisible=false" @submit="afterEditSubmit"></asset-reallocation-edit>
			</el-dialog>

			<!--新增 AssetDetail ass_asset_detail界面-->
			<el-dialog title="新增调拨单" center :fullscreen="true" :visible.sync="addFormVisible" @close="addClose" :close-on-click-modal="false">
				<asset-reallocation-add ref="assetReceive" :asset-receive="addForm" :visible="addFormVisible" @cancel="addFormVisible=false" @submit="afterAddSubmit"></asset-reallocation-add>
			</el-dialog>

			<el-dialog title="资产调拨" center :fullscreen="true" :visible.sync="detailFormVisible" @close="addClose" :close-on-click-modal="false">
				<asset-reallocation-detail ref="assetReceive" :asset-receive="detailForm" :visible="detailFormVisible" @cancel="detailFormVisible=false"></asset-reallocation-detail>
			</el-dialog>
...
<script>
	...
	import assetReallocationAdd from './assetReallocationAdd';
	import assetReallocationEdit from './assetReallocationEdit';
	import assetReallocationDetail from './assetReallocationDetail';
	...
	export default {
		...
		components: {
			...
			'asset-reallocation-edit' : assetReallocationEdit,
		},
		mounted() {
			//默认查询领用类型的数据
			this.$nextTick(() => {
