        ...
        <el-row class="page-container border padding">
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="类别">
							<el-input disabled placeholder="资产调拨单"></el-input>
						</el-form-item>
					</el-col>
            ...
            <el-row>
                <el-table size="small" border :data="assetData" stripe>
                    ...
                    <el-table-column prop="" align="center" label="调拨日期"  width="245">
                    ...
                    <el-table-column prop="deptName" align="center" label="原部门"  width="200">
                    </el-table-column>

                    <el-table-column prop="" align="center" label="现部门"  width="200">
                        <template slot-scope="row">
                    ...
                    <el-table-column prop="personLiableUserid" align="center" label="原责任人"  width="80">
                    </el-table-column>

                    <el-table-column prop="" align="center" label="现责任人"  width="100">
                        <template slot-scope="row">
                           <span class="vTip">*</span>
                    ...
                    <el-table-column prop="warehouseName" align="center" label="原地点"  width="120">
                    </el-table-column>

                    <el-table-column prop="" align="center" label="转移地点"  width="200">
                         <template slot-scope="row">
                            <span class="vTip">*</span>
                           <el-input @focus="openWarehouseSelect(row.$index)" v-model="assetData[row.$index].nowStoreAddress" size="mini"> </el-input>
...
<script>
    ...
    export default {
		...
		props:['assetReallocation','visible'],
		watch: {
	      'assetReallocation':function( assetReallocationOper ) {
	            this.addForm = assetReallocationOper;
          },
        ...
        methods: {
			...
			setDefaultParam() {
                ...
                this.addForm.id = sn();
                //操作类型：领用
                this.addForm.opType = "reallocation";
            ...
            validateDetail(index, position) {
				...
				switch(position) {
					...
					break;
					case 'three' :
                        this.isNull(param.nowStoreAddress) ? data.threeShow = true : data.threeShow = false;
                    break;
				}
			},
            ...
            selectUserClose() {
                this.isNull(this.assetData[this.currentRow].nowPsersonLiableUserid) ? this.validateData[this.currentRow].twoShow = true : this.validateData[this.currentRow].twoShow = false;
            },

            selectWarehouseClose() {
                this.isNull(this.assetData[this.currentRow].nowWarehouseId) ? this.validateData[this.currentRow].threeShow = true : this.validateData[this.currentRow].threeShow = false;
            },
		...
		mounted() {
			this.addForm=Object.assign(this.addForm, this.assetReallocation);
			this.setDefaultParam();
		}//end mounted
