...
import {editAssetDetail, addAssetDetail} from '@/api/oa/erp/ass/assetDetail';
...
export default {
  ...
  props: ['assetDetail', 'visible', 'opType'],
  watch: {

    'assetDetail': function (assetDetail) {
      this.editForm = assetDetail;
    },

    'visible': function (visible) {
      if (visible == true) {
        //从新打开页面时某些数据需要重新加载，可以在这里添加
        this.editForm = Object.assign(this.editForm, this.assetDetail);
  ...
  data() {
    return {
      currOpType: 'add',//add|edit 新增还是修改
  ...
  methods: {
    ...
    setDefaultParams() {
      ...
      this.uploadCategoryId = 'asset_detail_upload';
