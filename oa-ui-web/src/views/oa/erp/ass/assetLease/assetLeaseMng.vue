<template>
	<section class="page-container border padding">
		...
		<el-row class="page-main padding-top"> 
			...
			<el-dialog title="编辑出租/出借单" center :fullscreen="true" :visible.sync="editFormVisible" @close="addClose" :close-on-click-modal="false">
				  <asset-lease-edit ref="assetLease" :asset-receive="editForm" :visible="editFormVisible" @cancel="editFormVisible=false" @submit="afterEditSubmit"></asset-lease-edit>
			</el-dialog>

			<!--新增 AssetDetail ass_asset_detail界面-->
			<el-dialog title="新增出租/出借单" center :fullscreen="true" :visible.sync="addFormVisible" @close="addClose" :close-on-click-modal="false">
				<asset-lease-add ref="assetLease" :asset-receive="addForm" :visible="addFormVisible" @cancel="addFormVisible=false" @submit="afterAddSubmit"></asset-lease-add>
			</el-dialog>

			<el-dialog title="出租明细" center :fullscreen="true" :visible.sync="detailFormVisible" @close="addClose" :close-on-click-modal="false">
				<asset-lease-detail ref="assetLease" :asset-receive="detailForm" :visible="detailFormVisible" @cancel="detailFormVisible=false"></asset-lease-detail>
			</el-dialog>
...
<script>
	...
	import assetLeaseAdd from './assetLeaseAdd';
	import assetLeaseEdit from './assetLeaseEdit';
	import assetLeaseDetail from './assetLeaseDetail';
	...
	export default {
		...
		components: {
			...
			'asset-lease-edit' : assetLeaseEdit,
