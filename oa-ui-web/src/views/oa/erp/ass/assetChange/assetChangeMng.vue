<template>
	<section class="page-container border padding">
		...
		<el-row class="page-main padding-top"> 
			...
			<el-dialog title="编辑资产变更单" center :fullscreen="true" :visible.sync="editFormVisible" @close="addClose" :close-on-click-modal="false">
				  <asset-change-edit ref="assetReceive" :asset-receive="editForm" :visible="editFormVisible" @cancel="editFormVisible=false" @submit="afterEditSubmit"></asset-change-edit>
			</el-dialog>

			<!--新增 AssetDetail ass_asset_detail界面-->
			<el-dialog title="新增资产变更单" center :fullscreen="true" :visible.sync="addFormVisible" @close="addClose" :close-on-click-modal="false">
				<asset-change-add ref="assetReceive" :asset-receive="addForm" :visible="addFormVisible" @cancel="addFormVisible=false" @submit="afterAddSubmit"></asset-change-add>
			</el-dialog>

			<el-dialog title="资产变更明细" center :fullscreen="true" :visible.sync="detailFormVisible" @close="addClose" :close-on-click-modal="false">
				<asset-change-detail ref="assetReceive" :asset-receive="detailForm" :visible="detailFormVisible" @cancel="detailFormVisible=false"></asset-change-detail>
			</el-dialog>
...
<script>
	...
	import assetChangeAdd from './assetChangeAdd';
	import assetChangeEdit from './assetChangeEdit';
	import assetChangeDetail from './assetChangeDetail';
	...
	export default {
		...
		components: {
			...
			'asset-change-edit' : assetChangeEdit,
