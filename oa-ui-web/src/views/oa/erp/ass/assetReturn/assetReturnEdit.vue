...
<script>
    ...
    import {editMngFlow, getDetail} from '@/api/oa/erp/ass/assetMng';
    ...
    export default {
		...
		watch: {
	      'assetReturn':function( assetReceiveOper ) {
        ...
        methods: {
            ...
            getWarehouseData(data) {
                if(this.isBatchChange) {
                    this.assetData.forEach((a,index) => {
		...
		mounted() {
			this.editForm=Object.assign(this.editForm, this.assetReturn);
            this.setDefaultParam();
            this.getDetailData();
		}//end mounted
