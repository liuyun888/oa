<template>
	<section class="page-container border padding">
		...
		<el-row class="page-main padding-top"> 
			...
			<el-dialog title="编辑资产维修/保养单" center :fullscreen="true" :visible.sync="editFormVisible"  @close="addClose"  :close-on-click-modal="false">
				  <asset-maint-edit ref="assetReceive" :asset-receive="editForm" :visible="editFormVisible" @cancel="editFormVisible=false" @submit="afterEditSubmit"></asset-maint-edit>
			</el-dialog>

			<!--新增 AssetDetail ass_asset_detail界面-->
			<el-dialog title="新增资产维修/保养单" center :fullscreen="true" :visible.sync="addFormVisible" @close="addClose" :close-on-click-modal="false">
				<asset-maint-add ref="assetReceive" :asset-receive="addForm" :visible="addFormVisible" @cancel="addFormVisible=false" @submit="afterAddSubmit"></asset-maint-add>
			</el-dialog>

			<el-dialog title="资产维修/保养单明细" center :fullscreen="true" :visible.sync="detailFormVisible" @close="addClose" :close-on-click-modal="false">
				<asset-maint-detail ref="assetReceive" :asset-receive="detailForm" :visible="detailFormVisible" @cancel="detailFormVisible=false"></asset-maint-detail>
			</el-dialog>
...
<script>
	...
	import assetMaintAdd from './assetMaintAdd';
	import assetMaintEdit from './assetMaintEdit';
	import assetMaintDetail from './assetMaintDetail';
	...
	export default {
		...
		components: {
			...
			'asset-maint-edit' : assetMaintEdit,
