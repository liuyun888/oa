		 ...
		 <el-row class="page-container border padding"> 
			<el-form :model="editForm"  label-width="120px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="备注说明" prop="remark">
					<el-input type="textarea" :rows="3" v-model="editForm.remark" placeholder="备注说明"></el-input>
				</el-form-item> 
				<el-form-item> 
...
<script>
	...
	import { editOmCategory } from '@/api/oa/om/omCategory';
	...
	export default { 
		...
		watch: {
	      'omCategory':function( omCategory ) {
				this.editForm=Object.assign(this.editForm, this.omCategory); 
		...
		methods: {
			...
			//编辑提交OmCategory om_category父组件监听@submit="afterEditSubmit"
			editSubmit: function () {
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						this.$confirm('确认提交吗？', '提示', {}).then(() => { 
							...
							editOmCategory(params).then((res) => {
