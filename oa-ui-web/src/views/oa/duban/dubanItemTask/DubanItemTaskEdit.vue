		 ...
		 <el-row class="page-container border padding"> 
			<el-form :model="editForm"  label-width="120px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="督办主键" prop="dubanId">
					<el-input :disabled="true" v-model="editForm.dubanId" placeholder="督办主键"></el-input>
				</el-form-item> 
...
<script>
	...
	import { editDubanItemTask } from '@/api/oa/duban/dubanItemTask';
	...
	export default { 
		...
		data() {
			return {
				...
				//编辑界面数据  DubanItemTask duban_item_task
				editForm: {
		...
		methods: {
			...
			//编辑提交DubanItemTask duban_item_task父组件监听@submit="afterEditSubmit"
			editSubmit: function () {
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						this.$confirm('确认提交吗？', '提示', {}).then(() => { 
							...
							editDubanItemTask(params).then((res) => {
		...
		mounted() {
			this.editForm=Object.assign(this.editForm, this.dubanItemTask);  
		}
	}
