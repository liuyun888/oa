		...
		<!--编辑界面 MatterInfo 事项库-事项基本信息--> 
			<el-form :model="editForm" size="small" label-width="120px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="公司手册" prop="companyHandbook">
					<el-input v-model="editForm.companyHandbook" auto-complete="off"></el-input>
				</el-form-item> 
...
<script>
	...
	import { editMatterInfo } from '../../../../api/oa/matter/matterInfo';
	
	export default {
		props:['matterInfo','visible'],
		watch: {
	      'matterInfo':function( matterInfo ) {
	        this.editForm = matterInfo;
	      },
		...
		mounted() {
			this.editForm=Object.assign(this.editForm, this.matterInfo);
			//加载下拉列表 如有需要去掉注释
			/**
