		 ...
		 <el-row class="page-container border padding"> 
			<el-form :model="addForm"  label-width="120px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="路线编号" prop="routeId">
					<el-input v-model="addForm.routeId" placeholder="路线编号" ></el-input>
				</el-form-item> 
				<el-form-item>
...
<script>
	...
	import { addCarRequireRouteDetail } from '@/api/oa/car/carRequireRouteDetail';
	...
	export default { 
		...
		watch: {
	      'carRequireRouteDetail':function( carRequireRouteDetail ) {
	        this.addForm = carRequireRouteDetail;
	      },
		...
		data() {
			return {
				...
				//新增界面数据 car_require_route_detail
				addForm: {
		...
		methods: {
			...
			//新增提交CarRequireRouteDetail car_require_route_detail 父组件监听@submit="afterAddSubmit"
			addSubmit: function () {
				...
				this.$refs.addForm.validate((valid) => {
					if (valid) {
						...
						this.$confirm('确认提交吗？', '提示', {}).then(() => { 
							...
							addCarRequireRouteDetail(params).then((res) => {
								this.load.add=false
		...
		mounted() {
			this.addForm=Object.assign(this.addForm, this.carRequireRouteDetail);  
			/**在下面写其它函数***/
