        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="公司名称" prop="companyName" style="width:80%">
              <el-input v-model="editForm.companyName" placeholder="公司名称" maxlength="50"  clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="职位" prop="duty" style="width:80%">
              <el-input v-model="editForm.duty" placeholder="职位" maxlength="50"  clearable></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item label="工作描述" prop="remark" style="width:90%">
              <el-input v-model="editForm.remark" rows="5" type="textarea" placeholder="工作描述" maxlength="255"  clearable></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item label="离职原因" prop="dimissionCause" style="width:90%">
              <el-input v-model="editForm.dimissionCause" rows="5" type="textarea" placeholder="离职原因" maxlength="255"  clearable></el-input>
            </el-form-item>
          </el-col>
        </el-row>
       <!-- <el-row :gutter="20">
...
import { editHrUserWorked } from "@/api/oa/hr/user/hrUserWorked";
...
export default {
  ...
  data() {
    return {
      ...
      //编辑界面数据  HrUserWorked hr_user_worked
      editForm: {
        id: "",
        userid: "",
        companyName: "",
  ...
  methods: {
    ...
    //编辑提交HrUserWorked hr_user_worked父组件监听@submit="afterEditSubmit"
    editSubmit: function() {
  ...
  mounted() {
    this.editForm = Object.assign(this.editForm, this.hrUserWorked);
  }
};
</script>
