		 ...
		 <el-row class="page-container border padding"> 
			<el-form :model="editForm"  label-width="120px" :rules="editFormRules" ref="editForm">
				<el-form-item label="操作记录id" prop="operId">
					<el-input v-model="editForm.operId" placeholder="操作记录id"></el-input>
				</el-form-item> 
				<el-form-item label="客户id" prop="customerId">
					<el-input v-model="editForm.customerId" placeholder="客户id"></el-input>
				</el-form-item> 
				<el-form-item label="操作人" prop="operUserId">
					<el-input v-model="editForm.operUserId" placeholder="操作人"></el-input>
				</el-form-item> 
				<el-form-item label="操作人名称" prop="operUserName">
					<el-input v-model="editForm.operUserName" placeholder="操作人名称"></el-input>
				</el-form-item> 
				<el-form-item label="操作人部门id" prop="operDeptId">
					<el-input v-model="editForm.operDeptId" placeholder="操作人部门id"></el-input>
				</el-form-item> 
				<el-form-item label="操作人部门名称" prop="operDeptName">
					<el-input v-model="editForm.operDeptName" placeholder="操作人部门名称"></el-input>
				</el-form-item> 
				<el-form-item label="ip地址" prop="ipAddress">
					<el-input v-model="editForm.ipAddress" placeholder="ip地址"></el-input>
				</el-form-item> 
				<el-form-item label="之前的值" prop="oldValue">
					<el-input v-model="editForm.oldValue" placeholder="之前的值"></el-input>
				</el-form-item> 
				<el-form-item label="之后修改的值" prop="newValue">
					<el-input v-model="editForm.newValue" placeholder="之后修改的值"></el-input>
				</el-form-item> 
				<el-form-item label="create" prop="operType">
					<el-input v-model="editForm.operType" placeholder="create"></el-input>
				</el-form-item> 
...
<script>
	...
	import { editCustomerOpertion } from '@/api/oa/crm/customerOpertion';
	...
	export default { 
		...
		watch: {
	      'customerOpertion':function( customerOpertion ) {
	        this.editForm = customerOpertion;
	      },
		...
		data() {
			return {
				...
				//编辑界面数据  CustomerOpertion crm_customer_opertion
				editForm: {
		...
		methods: {
			...
			//编辑提交CustomerOpertion crm_customer_opertion父组件监听@submit="afterEditSubmit"
			editSubmit: function () {
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						this.$confirm('确认提交吗？', '提示', {}).then(() => { 
							...
							editCustomerOpertion(params).then((res) => {
		...
		mounted() {
			this.editForm=Object.assign(this.editForm, this.customerOpertion);  
		}
	}
