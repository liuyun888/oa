<template>
	<section class="page-container border padding">
		<el-row class="page-header">
			...
			<el-button type="primary" v-loading="load.list" :disabled="load.list==true" v-on:click="searchCustomerAddresss">查询</el-button>
			<el-button type="primary" @click="showAdd">+crm_customer_address</el-button>
		...
		<el-row class="page-main padding-top"> 
			...
			<el-table :data="customerAddresss" @sort-change="sortChange" highlight-current-row v-loading="load.list" border @selection-change="selsChange" @row-click="rowClick" style="width: 100%;">
				...
				<el-table-column prop="addressId" label="地址id" min-width="80" ></el-table-column>
				<el-table-column prop="curstomerId" label="客户id" min-width="80" ></el-table-column>
				...
				<el-table-column prop="phone" label="电话" min-width="80" ></el-table-column>
				<el-table-column prop="fax" label="传真" min-width="80" ></el-table-column>
				<el-table-column prop="email" label="电子邮件" min-width="80" ></el-table-column>
				<el-table-column prop="district" label="区县" min-width="80" ></el-table-column>
				<el-table-column prop="contacterUserId" label="联系人id" min-width="80" ></el-table-column>
				<el-table-column prop="contacterUserName" label="联系人名称" min-width="80" ></el-table-column>
				<el-table-column prop="typeId" label="地址类型" min-width="80" ></el-table-column>
				<el-table-column prop="typeName" label="地址类型名称" min-width="80" ></el-table-column>
				<el-table-column prop="appendAddress" label="附加地址" min-width="80" ></el-table-column>
			...
			<el-dialog title="编辑crm_customer_address" :visible.sync="editFormVisible"  width="50%"  :close-on-click-modal="false">
			...
			<el-dialog title="新增crm_customer_address" :visible.sync="addFormVisible"  width="50%"  :close-on-click-modal="false">
	...
	export default { 
		...
		data() {
			return {
				...
				addForm: {
					addressId:'',curstomerId:'',country:'',countryCode:'',province:'',provinceCode:'',city:'',cityCode:'',street:'',streetCode:'',district:'',districtCode:'',zipCode:'',phone:'',fax:'',email:'',contacterUserId:'',contacterUserName:'',typeId:'',typeName:'',appendAddress:''
				},
