  ...
  <div class="errPage-container">
    ...
    <el-row>
      <el-col :span="18">
        ...
        <h2>名称:{{tips.username?decodeURIComponent(tips.username):"还没设置账户名称"}}   账号:{{ tips.userid }}   {{tips.password?'密码:'+tips.password:'' }}</h2>
        <h6>您可以：</h6>
         <ul class="list-unstyled"> 
          <li class="link-type">
            <router-link to="/my/work/updateUserInfo" title="可以修改我的账户名称、密码等">修改账户(名称、密码、手机号等)</router-link>
          </li>   
          <li class="link-type">
